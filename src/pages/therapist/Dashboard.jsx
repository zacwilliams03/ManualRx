...
export default function TherapistDashboard() {
  ...
  return (
    <SidebarLayout>
      <ParticleBackground />
      <div style={{ position: 'fixed', inset: 0, background: '#06080f', zIndex: 1, pointerEvents: 'none' }} />
      <div style={{ position: 'relative', zIndex: 2, padding: '40px 40px 60px', minHeight: '100vh' }}>
        <motion.div
